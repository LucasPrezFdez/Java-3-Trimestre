...
//	Oficina							$ 3500 000
    ...
    public void pueblaValores() {
        ...
        this.valorUnitario.put("Casa rural", 1475d);
        this.valorUnitario.put("Casa en conjunto cerrado", 2175d);
        this.valorUnitario.put("Casa independiente", 3325d);
        this.valorUnitario.put("Apartaestudio", 1725d);
        this.valorUnitario.put("Apartamento familiar", 2475d);
        this.valorUnitario.put("Local comercial", 3425d);
        this.valorUnitario.put("Oficina", 3825d);
    }
