...
public class BonitoMain {
    ...
    public static void main(String[] args) {
        ...
        Producto producto5 = new Producto("Mochila", 5, "Mochila molona", 1 + random.nextFloat(200 - 1));

        Orden factura1 = new Orden(123);

        factura1.añadirLinea(1, random.nextInt(10) + 1, producto1);
        factura1.añadirLinea(2, random.nextInt(10) + 1, producto2);
        factura1.añadirLinea(3, random.nextInt(10) + 1, producto3);
        factura1.añadirLinea(4, random.nextInt(10) + 1, producto4);
        factura1.añadirLinea(5, random.nextInt(10) + 1, producto5);
        ...
        try (FileWriter writer = new FileWriter("LucasPerez.txt")) {
            ...
            writer.write("\n--------------------------------------------------\n");
            writer.write("Total factura con IVA (17%): " + String.format("%.2f", factura1.calcularTotalFacturaConIVA()) + " €");
