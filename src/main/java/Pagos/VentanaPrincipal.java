...
public class VentanaPrincipal extends JFrame implements ActionListener {
    ...
    public VentanaPrincipal() {
        ...
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); // Permite salir de la aplicación
    ...
    public void actionPerformed(ActionEvent evento) {
        ...
        if (evento.getSource() == itemMenu3) { // Se selecciona el ítem de menú 3
            ...
            fc.setFileSelectionMode(JFileChooser.DIRECTORIES_ONLY); // Es un selector de directorio
            ...
            if (respuesta == JFileChooser.APPROVE_OPTION) { // Si se pulsa aceptar en el selector
                ...
                String nombre = directorioElegido.getAbsolutePath(); // Se obtiene la ruta completa del directorio
                try {
                    ...
                    e.printStackTrace(); // En caso de que se presente una excepción
                }
            }
        }
    }
